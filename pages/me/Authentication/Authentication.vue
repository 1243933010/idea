<template>
	<view class="settleln-attest-con">
		<view class="navtab">
			...
			<view class="a"><text>身份认证</text></view>
			<view class=""></view>
		</view>
		...
		<view class="basic-info white-con">
			...
			<view class="icon">
				<image @click="chooseIcon" style="width: 120rpx;height: 120rpx;" :src="icon" mode=""></image>
			...
			<view class="inp-con user-card">
				<text>职位:</text>
				<input type="text" v-model="zhiwei"  placeholder="请输入您的职位"/>
			</view>
			<view class="inp-con user-card">
				<text>电话号码:</text>
			...
			<view class="inp-con user-card">
				<text>身份证:</text>
				<input type="text" v-model="sfzText"  placeholder="请输入您的身份证"/>
			</view>
		...
		<view class="prove white-con">
			...
			<view class="prove-list">
				<view class="prove-item">
					<image style="width: 300rpx;height: 200rpx;" @click="chooseSFZY" :src="sfzY" mode=""></image>
				</view>
				<view class="prove-item">
					<image  style="width: 300rpx;height: 200rpx;" @click="chooseSFZZ" :src="sfzZ" mode=""></image>
				</view>
			</view>
		</view>
		...
		methods: {
			...
			async btnOn(){
				let obj = {
					...
					identity_school:this.school,
					identity_position:this.zhiwei,
					identity_phone:this.phone,
					identity_card:this.sfzText,
					identity_desc:this.text,
				...
				let data = await this.$request('/api/v1/users_identity_apply',obj);
